...
module AllMainMethods
  ...
  def action_get_list_wagons_in_train
    ...
    while !go_again.zero?
      ...
      train.each_wagon do |wagon| 
        puts "#{wagon.type} wagon, places - #{wagon.some_place}" if wagon.type == 'passenger'
        puts "#{wagon.type} wagon, volume - #{wagon.some_place}" if wagon.type == 'cargo' 
      end
  ...
  def select_wagon(train)
    wagon_count = 1
    train.each_wagon do |wagon| 
        puts "#{wagon_count} - #{wagon.type} wagon, places - #{wagon.some_place}" if wagon.type == 'passenger'
        puts "#{wagon_count} - #{wagon.type} wagon, volume - #{wagon.some_place}" if wagon.type == 'cargo' 
        wagon_count += 1
      end
    index = Integer(gets) - 1
  ...
  def action_add_delete_place_volume_in_wagon
    ...
    while !go_again.zero?
      ...
      if wagon.type == 'cargo'
        puts "Free volume: #{wagon.some_place}"
        begin
        ...
        wagon.close_some_place(volume)
        puts "Free volume: #{wagon.some_place}"
      else
        puts "Free places before: #{wagon.some_place}"
        wagon.close_some_place
        puts "Free places after: #{wagon.some_place}"
      end
